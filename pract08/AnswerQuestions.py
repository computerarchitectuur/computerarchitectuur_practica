...
def ask_cache_contents(iteration):
    contents = []
...
if __name__ == '__main__':
    ...
    ask_question(answers, 'Dubbele lus 1a', ask_cache_contents, 10)
    ask_question(answers, 'Dubbele lus 1b', ask_cache_contents, 20)
    ask_question(answers, 'Dubbele lus 1c', ask_cache_contents, 50)

    ask_question(answers, 'Matrixvermenigvuldiging 1c', ask_cache_contents, 50)

    ask_question(answers, 'Matrixvermenigvuldiging 3a', ask_cache_contents, 10)
    ask_question(answers, 'Matrixvermenigvuldiging 3b', ask_cache_contents, 20)
    ask_question(answers, 'Matrixvermenigvuldiging 3c', ask_cache_contents, 50)
